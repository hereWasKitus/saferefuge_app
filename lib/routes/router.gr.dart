...
import '../login/login.dart' as _i5;
import '../map/map.dart' as _i4;
...
class AppRouter extends _i8.RootStackRouter {
  ...
  final Map<String, _i8.PageFactory> pagesMap = {
    ...
    RegistrationFourthStepRoute.name: (routeData) {
      return _i8.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i3.RegistrationView4());
    },
  ...
  List<_i8.RouteConfig> get routes => [
        ...
        _i8.RouteConfig(HomeScreenRoute.name, path: '/home'),
        ...
        _i8.RouteConfig(ProfileRoute.name, path: '/profile', children: [
